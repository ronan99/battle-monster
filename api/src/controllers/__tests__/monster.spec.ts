...
describe('MonsterController', () => {
  ...
  describe('Import CSV', () => {
    test('should fail when importing csv file with an empty monster', async () => {
      const getResponse = await request(server).post('/monsters/import').attach('monsters', './data/monsters-empty-monster.csv')
    ...
    test('should fail when importing csv file with wrong or inexistent columns.', async () => {
      const getResponse = await request(server).post('/monsters/import').attach('monsters', './data/monsters-correct.csv')
    ...
    test('should import all the CSV objects into the database successfully', async () => {
      const getResponse = await request(server).post('/monsters/import').attach('monsters', './data/monsters-wrong-column.csv')
